...
export default function BottomNavigation() {
  ...
  const items = [
    ...
    { key: 'tours' as const, icon: Compass, label: locale === 'es' ? 'Tours' : 'Tours', href: '/tour-packages', active: pathname.startsWith('/tour-packages') || pathname.startsWith('/tours') || pathname.startsWith('/customized-tours') },
