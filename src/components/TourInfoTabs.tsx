    ...
    <div className="w-full max-w-3xl mx-auto">
      ...
      {activeTab === 'policies' && (
        <div className="bg-[#141414] border border-white/10 rounded-2xl p-5 sm:p-6 space-y-6">
          {policies.length > 0 && (
            <div>
              <h4 className="text-xs sm:text-sm font-bold uppercase tracking-widest text-[#D6B37F] mb-3">
              ...
              <ul className="space-y-3">
                {policies.map((policy, idx) => (
                  ...
                  >
                    <AlertTriangle className="w-4 h-4 text-[#D6B37F] shrink-0 mt-0.5" />
                    {policy}
                  </li>
                ))}
              </ul>
