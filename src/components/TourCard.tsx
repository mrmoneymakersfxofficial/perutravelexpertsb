          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 z-10 p-4 sm:p-5 pt-16">
              ...
              <div className="flex items-end justify-between">
                ...
                <span
                  className="h-9 sm:h-10 px-4 sm:px-5 rounded-xl text-[11px] sm:text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 transition-all duration-300 shrink-0"
