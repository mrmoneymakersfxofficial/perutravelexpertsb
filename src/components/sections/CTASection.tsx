  ...
  return (
    <section className="py-20 md:py-28 relative overflow-hidden" style={{ backgroundColor: '#0C0C14' }}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#C8A97E]/10 rounded-full blur-3xl" />
        {/* Pattern */}
        <div className="absolute inset-0 opacity-5"
          style={{
            backgroundImage: `radial-gradient(circle at 1px 1px, #C8A97E 1px, transparent 0)`,
