      ...
      <section className="py-12 md:py-16" style={{ backgroundColor: '#FAF8F5' }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-[#8B8680] text-lg leading-relaxed mb-6">
            {locale === 'es'
              ? 'En Intiquilla creemos que el turismo debe ser una fuerza positiva. Apoyamos activamente proyectos comunitarios que preservan la cultura andina y mejoran la calidad de vida de las familias locales.'
              : 'At Intiquilla we believe tourism should be a positive force. We actively support community projects that preserve Andean culture and improve the quality of life for local families.'}
          </p>
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-[#E8D5B5]/20">
                      <div className="relative h-56 overflow-hidden">
                        ...
                        <div className="absolute bottom-4 left-4">
                          <h3 className="font-playfair text-2xl font-bold text-white drop-shadow-lg">
                            {name}
                          </h3>
                        </div>
                      </div>
                      <div className="p-6">
                        <p className="text-[#8B8680] text-sm leading-relaxed mb-4 line-clamp-4">
                          {desc}
                        </p>
