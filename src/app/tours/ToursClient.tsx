  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#0F0F0F' }}>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-px" style={{ background: 'linear-gradient(90deg, transparent, #D6B37F, transparent)' }} />
        ...
        <div className="relative z-10 flex items-center justify-center px-4 sm:px-6 py-24 sm:py-32 md:py-40">
          ...
          >
            ...
            <motion.div
              ...
              style={{ background: 'rgba(214,179,127,0.15)', border: '1px solid rgba(214,179,127,0.25)' }}
            >
              <MapPin className="w-3.5 h-3.5" style={{ color: '#D6B37F' }} />
              <span className="text-xs font-semibold tracking-wider uppercase" style={{ color: '#D6B37F' }}>
            ...
            <div key={group.id} className={groupIdx > 0 ? 'mt-20 sm:mt-24 md:mt-28' : ''}>
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <MapPin className="w-5 h-5 flex-shrink-0" style={{ color: '#D6B37F' }} />
                  ...
                  <span
                    ...
                    style={{ color: '#D6B37F', background: 'rgba(214,179,127,0.12)', border: '1px solid rgba(214,179,127,0.2)' }}
                  >
                ...
                {/* Gold underline */}
                <div className="ml-8 w-16 h-0.5" style={{ backgroundColor: '#D6B37F' }} />
              </motion.div>
                        ...
                        >
                          ...
                          <div className="absolute top-0 left-0 right-0 z-10 flex items-start justify-between p-3 sm:p-4">
                            ...
                            <div
                              ...
                              style={{
                                backgroundColor: 'rgba(214,179,127,0.9)',
                                boxShadow: '0 2px 12px rgba(214,179,127,0.3)',
                              }}
                            >
                          ...
                          <div className="absolute bottom-0 left-0 right-0 z-10 p-4 sm:p-5 pt-12 sm:pt-16">
                            {/* Tour name */}
                            <h3 className="font-playfair text-lg sm:text-xl md:text-2xl font-bold text-white leading-tight mb-2 group-hover:text-[#D6B37F] transition-colors duration-300">
                              {name}
                            </h3>

                            {/* Divider */}
                            <div
                              className="w-full h-px mb-3 group-hover:bg-[#D6B37F]/30 transition-colors duration-300"
                          ...
                          <div
                            ...
                            style={{ boxShadow: 'inset 0 0 60px rgba(214,179,127,0.06)' }}
                          />
                        </div>
                      </Link>
                    </motion.div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                ...
                style={{
                  ...
                  color: '#0F0F0F',
                  boxShadow: '0 4px 24px rgba(214,179,127,0.25)',
                }}
              >
