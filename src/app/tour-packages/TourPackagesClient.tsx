...
export default function TourPackagesClient() {
  ...
  const sectionIds = ['packages-hero', 'packages-destinations', 'packages-cta'];
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#F8F6F2' }}>
      ...
      <section id="packages-hero" className="relative h-64 md:h-80 overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center">
            ...
            <p className="text-[#E8D5B5] text-lg max-w-2xl mx-auto px-4">{t.tourDetail.ourDestinations}</p>
          </div>
        </div>
      </section>

      <section id="packages-destinations" className="py-16 md:py-20" style={{ backgroundColor: '#F8F6F2' }}>
      ...
      <section id="packages-cta" className="py-12" style={{ backgroundColor: '#0F0F0F' }}>
