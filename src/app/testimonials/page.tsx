...
export const metadata: Metadata = {
  ...
  description: 'Read what our travelers say about their experiences with PeruTravelExpertsB. Real testimonials from unforgettable VIP tours in Cusco and Machu Picchu.',
