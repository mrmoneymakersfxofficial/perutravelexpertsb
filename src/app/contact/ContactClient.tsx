              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={getWhatsAppLink('Hola, me interesa información sobre los tours de PeruTravelExpertsB')} target="_blank" rel="noopener noreferrer" className="text-[#8B8680] hover:text-[#D4A843] transition-colors">+51 984 215 157</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
