...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#FAF8F5' }}>
      <PageHeader
        title={t.pageHeaders.contact}
        subtitle={t.contact.subtitle}
        breadcrumbs={[
          { label: locale === 'es' ? 'Inicio' : 'Home', href: '/' },
          { label: t.pageHeaders.contact },
        ]}
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
                ...
                <div className="w-full h-64 bg-[#E8D5B5]/20 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-[#8B8680] text-sm">
                      {locale === 'es' ? 'Cusco, Perú' : 'Cusco, Peru'}
                    </p>
                    <p className="text-[#8B8680]/60 text-xs mt-1">
                      -13.5319, -71.9675
                    </p>
                  </div>
                </div>
            ...
            >
              ...
              >
                ...
                <div>
                  <Label htmlFor="contact-subject" className="text-sm font-medium" style={{ color: '#2C1810' }}>
